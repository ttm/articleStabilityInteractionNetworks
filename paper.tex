...
\noindent where $\eta_k$ is the number of vertices with degree $k$, while $\overline{\Delta}_{i-1}=max(\Delta_{i-1})$, and $\overline{\Delta}_{0}=-1$. Equation~\ref{criterio} can now be written in the form:
