...
\begin{figure}
   \centering
	...
	\caption{A scatter plot of messages (M) versus participants (N) versus threads ($\Gamma$) of 140 email lists. The highest number of threads are found in lists with few participants. The correlation between $N$ and $\Gamma$ is negative for low values of $N$ but positive otherwise.}
	\label{fig:nmgamma3d}
\end{figure}
