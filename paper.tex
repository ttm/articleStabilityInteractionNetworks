...
but the very small standard deviations of principal components formation (Section~\ref{}),
the presence of the Erd\"os sectors even in networks with
few participants (Section~\ref{}),
and the recurrent activity patterns along different timescales (Section~\ref{}),
...
might add to current understanding of how Digraphs differ from
undirected graphs.
Noteworthy is the also very stable fraction participants in each Erd\"os sectors
...
about the generality of such results.
...
and might be enhanced to yield scientific knowledge~\cite{pnud3,pnud4,pnud5}.
Also, we should pursue the publication of the visualization and sonification
processes used for this research~\cite{versinus,4hubs} and
