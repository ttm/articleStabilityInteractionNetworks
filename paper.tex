...
The reminder of this section contains a detailed discussion of these results and Support Information holds further tables and figures from which such results can be better observed. The user activity exhibited in Table~\ref{autores} is 
...
\begin{table}[!h!]
    \caption{Distribution of activity among agents. First column presents the percentage of messages sent by the most active participant. Column for the first quartile ($1Q$) exhibits minimum percentage of participants responsible for at least 25\% of total messages. Similarly, the column for the first three quartiles $1-3Q$ exhibits minimum percentage of participants responsible for 75\% of total messages. The last decile $-10D$ column has maximum percentage of participants responsible for 10\% of messages.}
\begin{center}
...
This stability in network behavior is remarkable, with small standard deviations of the contribution of each metric to principal components in all lists analyzed. Table~\ref{fig:pcain} exemplifies the principal components formation with all measures considered, while Tables~\ref{compPCA0}-\ref{compPCA2} of Support Information gives further assistance to the interested reader.
