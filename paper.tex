...
\begin{figure*} 
   \centering
	...
	\caption{Prevalence of the symmetry-related measures over clustering for dispersion of participants in the space of topological measures. This is an important result from the PCA analysis, together with stability of component formation, and can be observed in Table~\ref{tab:pcain}.
