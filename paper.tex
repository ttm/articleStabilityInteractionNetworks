...
The column for the first quartile ($1Q$) exposes 
...
Similarly, the column for the first three quartiles $3Q$
gives the minimum percentage of participants responsible for 75\% of total messages.
The last decile $-10D$ column exposes the maximum percentage of participants responsible for 10\% of messages.}
	\begin{center}
		\begin{tabular}{ | l ||  c | c | c | c | }
			\hline
			list & hub & $ 1Q $ & $ 3Q $ & $-10D$ \\ \hline
