...
\altaffiliation{
Curso de Psicologia, Universidade Federal do Cear\'a (UFC), Campus Sobral
}%Lines break automatically or can be forced with \\
...
\begin{abstract}
	...
	with benchmarks derived from public email lists. Activity\hl{, recognized through messages sent,}
...
\hl{Directed and weighted representations were built through the observation of replies as links.}
...
\hl{These two paragraphs were switched.}
...
\hl{"Availability" subsection heading removed}
