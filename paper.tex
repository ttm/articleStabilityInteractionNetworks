...
This finding is illustrated with data from 140 email lists in the Figures~\ref{fig:nmgamma} and~\ref{fig:nmgamma3d} in the Supporting Information
and can also be observed in Table~\ref{tab:genLists}. Network types can be derived from such results, which is left for the reader and future work. 
