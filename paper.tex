...
\begin{abstract}
 ...
 The results also embrace a sketch of a physics-based typology of agents.
...
\begin{figure*} 
   \centering
	...
	\caption{The first plot shows degree versus clustering coefficient.
		In the second plots, the first component is an average of centrality metrics, but the second component is still clustering coefficient.
		...
		This general layout is recurrent and consistent with the literature: most connected vertices have low clusterization while higher clusterization is gradually more incident as the number of connections is lowered.
		This prevalence of the symmetry-related measures over clustering coefficient for the dispersion of participants in the space of topological measures is an important result from the PCA analysis, together with temporal stability of component formation, and can be observed in Table~\ref{tab:pcain}.
...
Let a sector to which a vertex belongs yield a type for the corresponding participant. Accordingly, a participant may be considered peripheral, intermediary or a hub. This trivial consideration raises important questions: is this typology stigmatizing or prejudice inclined in any way? What else do we know about each type and about the typology itself?
...
This typology is a bridge from exact to human sciences and may be enriched with concepts from other typologies, such as Meyer-Briggs, Pavlov or the authoritarian types of the F-Scale~\cite{adorno}.
