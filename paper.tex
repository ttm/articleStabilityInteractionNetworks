...
Each time scale also revealed patterns through histograms in Tables~\ref{tab:hin},~\ref{tab:win},~\ref{tab:min} and~\ref{tab:min2}. The exceptions of the seconds, minutes and years scales received dedicated Sections~\ref{sec:secmin} and~\ref{sec:years}.
