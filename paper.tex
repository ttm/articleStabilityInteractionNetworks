...
\title[Stability of interaction networks]{Temporal stability in human interaction networks}% Force line breaks with \\
...
Principal Component Analysis (PCA) is a well documented technique~\cite{pca} and was used to know: 1) what metrics contribute to each principal component and in which proportion; 2) how much of the dispersion is concentrated in each component; 3) expected values and dispersions for these quantities over various networks.
