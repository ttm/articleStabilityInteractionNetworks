...
\title[Interaction networks stability (Supporting Information)]{Temporal stability in human interaction networks: sector sizes, topological prominence and activity along different timescales (Supporting Information document)}% Force line breaks with \\
